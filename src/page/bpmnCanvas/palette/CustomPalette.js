...
var theme = localStorage.theme ? 'dark' : 'white';
  ...
  forEach(entries, function (entry, id) {
    ...
    if (theme === 'dark') {
      var html =
        entry.html ||
        (entry.separator
          ? '<div id="separatorDark"/>'
          : entry.titleName
            ? `<div class="titleNameStyleDark">${entry.titleName}</div>`
            : '<div class="entry entryDark" id="entryStyle" draggable="true"></div>')
    } else {
      var html =
        entry.html ||
        (entry.separator
          ...
          : entry.titleName
            ...
            : '<div class="entry" id="entryStyle" draggable="true"></div>')
    }
