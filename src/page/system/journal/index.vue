<template>
  <div class="journal">
    <div class="contents">
      <div class="form" />
      <div class="mainRight">
        <el-select v-model="value" class="firstSelect" clearable @change="handleChange">
          <el-option v-for="item in arr" :key="item.id" :label="item.name" :value="item.id" />
        </el-select>
        <el-select v-model="value1" clearable @change="handleChange1">
        ...
        <el-date-picker
          ...
          class="daterange "
          type="daterange"
          :start-placeholder="$t('时间起')"
          :end-placeholder="$t('时间止')"
      ...
      tableColumns: [
        ...
        },
        {
          ...
          render: (r, { row }) => {
            return (
              <span>
                {row.categoryOne ? row.categoryOne : '' + row.categoryTwo}
              </span>
            )
          }
        },
        ...
        },
        {
          ...
          label: '详情',
          render: (r, { row }) => {
            return <span style='font-size:26px' class={row.remark}></span>
          }
        }
      ],
      // 表格参数配置
